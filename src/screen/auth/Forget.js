        ...
        <View style={{ padding: 10, backgroundColor: '#fff' }}>
          ...
          <View style={styles.formInput}>
            <TouchableOpacity style={styles.defaultButton}>
              <Text style={{ textAlign: 'center', fontSize: 16, color: '#fff' }}>Send Rest Link</Text>
            </TouchableOpacity>
          ...
          <View style={styles.formInput}>
            <TouchableOpacity onPress={()=>{ naviation.navigate("Login") }}>
              <Text style={{ color: '#4287f5', textAlign: 'center', fontSize: 16, fontWeight: 'bold' }}>Already have an Account ? Login Now</Text>
            </TouchableOpacity>
          </View>
